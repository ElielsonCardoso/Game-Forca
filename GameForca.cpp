...
char dicaD[][50]={"frase Penso logo existo!","pertubação na atmosfera terrestre","um dos países mais pobres do mundo","local da invenção do chuveiro elétrico","casas decimais do número pi","periodo pré-histórico","explicação da origem das coisas","saida do Reino Unido da União Europeia"}; 
